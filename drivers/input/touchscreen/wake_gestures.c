...
/* flounder */
#define SWEEP_Y_MAX             2304
#define SWEEP_X_MAX             3072
#define SWEEP_EDGE		130
#define SWEEP_Y_LIMIT           SWEEP_Y_MAX-SWEEP_EDGE
#define SWEEP_X_LIMIT           SWEEP_X_MAX-SWEEP_EDGE
#define SWEEP_X_B1              1136
#define SWEEP_X_B2              1996
#define SWEEP_Y_START		960
#define SWEEP_X_START		1510
#define SWEEP_X_FINAL           768
...
static int __init wake_gestures_init(void)
{
	...
	if (!wake_dev) {
		pr_err("Can't allocate wake device\n");
		goto err_alloc_dev;
	}
